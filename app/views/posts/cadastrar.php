<div class="col-12 col-sm-8 mx-auto p-5">
    <div class="card">
        <div class="card-body">
            ...
            <form class="my-3 needs-validation" name="cadastrarPost" method="POST" action="<?= URL ?>/posts/cadastrar">
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col">
                        <a class="btn btn-outline-secondary btn-block" href="<?= URL ?>/posts">Voltar</a>
                    </div>
